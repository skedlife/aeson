-- | Like @<https://hackage.haskell.org/package/aeson-qq/docs/Data-Aeson-QQ.html Data.AesonAlt.QQ>@ but without interpolation.
module Data.AesonAlt.QQ.Simple (aesonQQ) where
...
-- | Converts a string representation of a JSON value into 'Data.AesonAlt.Value' at compile-time.
--
-- @
