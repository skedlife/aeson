...
module Data.AesonAlt.Types.ToJSON
    (
    -- * Core JSON classes
      ToJSON(..)
...
import Data.AesonAlt.Internal.Prelude

import Control.Monad.ST (ST)
import Data.AesonAlt.Encoding (Encoding, Encoding', Series, dict, emptyArray_)
import Data.AesonAlt.Encoding.Internal ((>*<))
import Data.AesonAlt.Internal.Functions (mapKeyVal, mapKeyValO)
import Data.AesonAlt.Types.Generic (AllNullary, False, IsRecord, One, ProductSize, Tagged2(..), True, Zero, productSize)
import Data.AesonAlt.Types.Internal
...
import GHC.Generics
import qualified Data.AesonAlt.Encoding as E
import qualified Data.AesonAlt.Encoding.Internal as E (InArray, comma, econcat, retagEncoding, key)
...
import qualified Data.AesonAlt.Encoding.Builder as EB
...
--
-- * "Data.AesonAlt.TH" provides Template Haskell functions which will derive an
...
--   >           -- text function is from Data.AesonAlt.Encoding
--
...
--
-- Instead of manually writing your 'ToJSON2' instance, "Data.AesonAlt.TH"
...
--
-- instance 'Data.AesonAlt.FromJSON.FromJSON1' F where
--     'Data.AesonAlt.FromJSON.liftParseJSON' p _ v = F \<$\> 'Data.AesonAlt.FromJSON.liftParseJSON' p ('Data.AesonAlt.FromJSON.listParser' p) v
-- @
