...
module Data.AesonAlt.Types.FromJSON
    (
    -- * Core JSON classes
      FromJSON(..)
...
import Data.AesonAlt.Decoding.Conversion (unResult, toResultValue, lbsSpace)
import Data.AesonAlt.Internal.Functions (mapKey, mapKeyO)
import Data.AesonAlt.Internal.Scientific
import Data.AesonAlt.Types.Generic
...
import qualified Data.AesonAlt.Parser.Time as Time
...
--
-- Instead of manually writing your 'FromJSON2' instance, "Data.AesonAlt.TH"
...
-- | Helper function to use with 'liftParseJSON'. See 'Data.AesonAlt.ToJSON.listEncoding'.
...
-- is an 'Data.AesonAlt.Object' and fails otherwise.
--
-- ==== Error message example
--
...
-- 'Data.AesonAlt.String' and fails otherwise.
--
-- ==== Error message example
--
...
-- an 'Data.AesonAlt.Array' and fails otherwise.
--
-- ==== Error message example
--
...
-- when @value@ is a 'Data.AesonAlt.Number' and fails using 'typeMismatch'
-- otherwise.
--
