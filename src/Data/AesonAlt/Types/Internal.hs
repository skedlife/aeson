...
-- |
-- Module:      Data.AesonAlt.Types.Internal
...
import Data.AesonAlt.KeyMap (KeyMap)
...
data Options = Options
    ...
    , omitNothingFields :: Bool
      ...
      --
      -- In @aeson-2.2@ this flag is generalised to omit all values with @'Data.AesonAlt.Types.omitField' x = True@.
    ...
    , rejectUnknownFields :: Bool
      -- ^ Applies only to 'Data.AesonAlt.FromJSON' instances. If a field appears in
...
-- | Options for encoding keys with 'Data.AesonAlt.Types.genericFromJSONKey' and
-- 'Data.AesonAlt.Types.genericToJSONKey'.
